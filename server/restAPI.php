...
class restAPI {
    ...
    private function buildLanguagesList() {
        $hardCodedLanguages = array(array(1,'PHP'),array(2,'Flutter'),array(1,'JavaScript'),array(1,'CSS3'));
        $tmp_languages = array();
    ...
    private function buildLecturersList() {
        $hardCodedLecturers = array(array(1, 'Eli Rotenberg', 'eli@eli.com',array(1,2,3)),array(1, 'Aviad Kahanoff', 'aviad@k.com',array(2,3,4)));
        $tmp_lecturers = array();
